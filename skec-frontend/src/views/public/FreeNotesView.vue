<template>
  <div class="flex flex-col min-h-screen bg-gray-50" style="font-family: 'Outfit', 'Inter', sans-serif;">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="h-14 flex items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-3 flex-1 justify-center">
            ...
            <span v-if="!loading" class="text-xs text-gray-400 hidden sm:inline">
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-12">
      ...
      <!-- Empty state -->
      <div v-else-if="!filteredNotes.length" class="text-center py-24">
        ...
        <p class="text-gray-500 font-medium">
          {{ search ? 'No notes match your search.' : 'No free notes published yet.' }}
        </p>
